...
if($PASSWORD) {
	...
	if(!$_SESSION['_sfm_allowed']) {
		...
		<body><center><form action=? method=post><b>Password</b><br><input type=password name=p autofocus/><br><input type="submit" value="Submit"/></form></center></body></html>';
		exit;
	}
}
...
<link rel="icon" href="/css/ok.png">
<link href="css/style.css" rel="stylesheet" type="text/css">

     <title>Easy File Uploader</title>
<meta http-equiv="content-type" content="text/html; charset=utf-8">
<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0">
<style>
body {font-family: "lucida grande","Segoe UI",Arial, sans-serif; font-size: 14px;
    max-width:700px; 
...
body:after{content:"Copyright ©  Asikur Rahman";
    display:block;background: #336e32 ; 
    background-repeat:x;z-index:1;
    position:relative;text-align:center;font-weight:bold;
    padding:7px;color:#fff; border-top: 0px solid #FF0000 ;
...
thead {border-top: 1px solid #82CFFA; border-bottom: 1px solid #96C4EA;border-left: 0px solid #E7F2FB;
	border-right: 0px solid #E7F2FB; }
#top {height:52px;}
#mkdir {display:inline-block;float:right;padding-top:16px;}
label { display:block; font-size:14px; color:#555;}
#file_drop_target {padding:7px 0; border: 1px solid #c1c1c1;font-size:15px;color:#ccc;
}
#file_drop_target.drag_over {border: 4px dashed #96C4EA; color: #96C4EA;}
#upload_progress {padding: 4px 0;}
#upload_progress .error {color:#a00;}
#upload_progress > div { padding:5px ;}
...
td { padding:.2em 1em .2em .2em; border-bottom:1px solid #c1c1c1;height:30px; font-size:14px;}
td.first {font-size:14px;}
...
a.delete {display:inline-block;
	...
	color:#d00;	margin-left: 15px;font-size:14px;padding:0 0 0 13px;
}
.name:before {
	content:'♦';
	color:#ce0000;
...
<?php endif; ?>
	...
	function renderFileRow(data) {
		...
		var $html = $('<tr />')
			...
			.append( $('<td/>').attr('data-sort',data.mtime) )
...
<div style='background: #336e32; padding: 10px; color: #fff;'>
    
       <center> <font size='06'><b>Upload Your File Easy</b></font><br></center>
...
<table id="table"><thead><tr>
	<th width='90%'>Name</th>
	<th><b><font color='red'>S</font></b></th>
